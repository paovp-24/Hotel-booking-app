    ...
    public class HotelController : ApiController
    {
        ...
        public IHttpActionResult GetId(int id)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"SELECT HOT_CODIGO, HOT_NOMBRE, HOT_EMAIL, HOT_DIRECCION, HOT_TELEFONO,
                                                            HOT_CATEGORIA FROM HOTEL
        ...
        public IHttpActionResult GetAll()
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"SELECT HOT_CODIGO, HOT_NOMBRE, HOT_EMAIL, HOT_DIRECCION, HOT_TELEFONO,
                                                            HOT_CATEGORIA FROM HOTEL", sqlConnection);
        ...
        private bool RegistrarHotel(Hotel hotel)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["RESERVAS"].ConnectionString))
            {
                SqlCommand sqlCommand = new SqlCommand(@"INSERT INTO HOTEL (HOT_NOMBRE, HOT_EMAIL, HOT_DIRECCION, 
                                                        HOT_TELEFONO, HOT_CATEGORIA) VALUES (@HOT_NOMBRE, @HOT_EMAIL,
        ...
        private bool ActualizarHotel(Hotel hotel)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["RESERVAS"].ConnectionString))
            {
                SqlCommand sqlCommand = new SqlCommand(@"UPDATE HOTEL SET HOT_NOMBRE = @HOT_NOMBRE, 
                                                                          HOT_EMAIL = @HOT_EMAIL, 
