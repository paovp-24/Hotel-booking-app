    ...
    public class SucursalController : ApiController
    {
        ...
        public IHttpActionResult GetId(int id)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"SELECT SUC_ID , SUC_NOMBRE, SUC_UBICACION , SUC_CORREO, SUC_TELEFONO FROM SUCURSAL
                    ...
                    while (sqlDataReader.Read())
                    {
                        ...
                        sucursal.SUC_UBICACION = sqlDataReader.GetString(2);
        ...
        public IHttpActionResult GetAll()
        {
            ...
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["RESERVAS"].ConnectionString))
                {
                    SqlCommand sqlCommand = new SqlCommand(@"SELECT SUC_ID , SUC_NOMBRE, SUC_UBICACION , SUC_CORREO, SUC_TELEFONO FROM SUCURSAL", sqlConnection);
        ...
        private bool RegistrarSucursal(Sucursal sucursal)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["RESERVAS"].ConnectionString))
            {
                SqlCommand sqlCommand = new SqlCommand(@"INSERT  INTO SUCURSAL ( SUC_NOMBRE, SUC_UBICACION , SUC_CORREO, SUC_TELEFONO ) VALUES (
                ...
                sqlCommand.Parameters.AddWithValue("@SUC_UBICACION", sucursal.SUC_UBICACION);
